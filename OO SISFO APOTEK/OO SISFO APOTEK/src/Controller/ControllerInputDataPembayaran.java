 ...
 * @author PUTRI
 */
public class ControllerInputDataPembayaran implements ActionListener{
    private InputDataPembayaran view;
    private Database db;

    public ControllerInputDataPembayaran( Database db) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            Logger.getLogger(ControllerInputDataPembayaran.class.getName()).log(Level.SEVERE, null, ex);
        }
        //eksekusi button 
        try{
