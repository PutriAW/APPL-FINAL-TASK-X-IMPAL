 ...
 * @author PUTRI
 */
public class ControllerEditDataObat implements ActionListener{
    private EditResepObat view;
    private Database db;

    public ControllerEditDataObat( Database db) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            Logger.getLogger(ControllerEditDataObat.class.getName()).log(Level.SEVERE, null, ex);
        }
        //eksekusi button
