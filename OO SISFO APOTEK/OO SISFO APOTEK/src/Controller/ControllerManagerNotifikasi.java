 ...
 * @author PUTRI
 */
public class ControllerManagerNotifikasi implements ActionListener, KeyListener{
    private ManagerNotifikasi view;
    private Database db;

    public ControllerManagerNotifikasi( Database db) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            Logger.getLogger(ControllerManagerNotifikasi.class.getName()).log(Level.SEVERE, null, ex);
        }
        //eksekusi button
