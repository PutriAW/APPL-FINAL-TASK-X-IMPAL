 ...
 * @author PUTRI
 */
public class ControllerEditDataPemesanan implements ActionListener{
    private EditResepObat view;
    private Database db;

    public ControllerEditDataPemesanan( Database db) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            Logger.getLogger(ControllerEditDataPemesanan.class.getName()).log(Level.SEVERE, null, ex);
        }
        //eksekusi button
        if (click.equals(view.getBtnSimpan())) {
           // PemesananModel p = new PemesananModel(view.getID(), view.getTotal(), view.getTglPesan());
            ...
            new ControllerEditDataPemesanan(db);
            view.dispose();
