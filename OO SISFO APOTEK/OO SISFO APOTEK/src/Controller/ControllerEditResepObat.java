 ...
 * @author PUTRI
 */
public class ControllerEditResepObat implements ActionListener{
    private EditResepObat view;
    private Database db;

    public ControllerEditResepObat( Database db) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            Logger.getLogger(ControllerEditResepObat.class.getName()).log(Level.SEVERE, null, ex);
        }
        //eksekusi button
        if (click.equals(view.getBtnSimpan())) {
           // PemesananModel p = new PemesananModel(view.getID(), view.getTotal(), view.getTglPesan());
            ...
            new ControllerEditResepObat(db);
            view.dispose();
