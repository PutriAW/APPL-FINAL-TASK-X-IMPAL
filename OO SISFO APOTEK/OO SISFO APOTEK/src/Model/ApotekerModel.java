 ...
 * @author MY PC
 */
public class ApotekerModel extends Karyawan{
    private String id_apoteker;

    public ApotekerModel(String id_apoteker, String nama, String jenis_kelamin, String tempat_lahir, String tanggal_lahir, String alamat, String no_hp) {
