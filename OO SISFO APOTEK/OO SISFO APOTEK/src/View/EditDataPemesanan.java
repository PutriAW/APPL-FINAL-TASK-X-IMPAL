 ...
 * @author PUTRI
 */
public class EditDataPemesanan extends javax.swing.JFrame {

    /**
     * Creates new form Supplier
     */
    public EditDataPemesanan() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        pmsPnl.add(tglLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, -1, -1));

        totalLbl.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        totalLbl.setText("Total Pemesanan");
        pmsPnl.add(totalLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 170, -1));

        tfId.setForeground(new java.awt.Color(204, 204, 204));
        tfId.setText("Default");
        tfId.setMinimumSize(new java.awt.Dimension(6, 30));
        pmsPnl.add(tfId, new org.netbeans.lib.awtextra.AbsoluteConstraints(222, 41, 420, 35));
        ...
        pmsPnl.add(tfTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 150, 420, 35));
        pmsPnl.add(dcPms, new org.netbeans.lib.awtextra.AbsoluteConstraints(222, 94, 420, 35));
        ...
        judulLbl.setText("Edit Detail Pemesanan");
...
//            java.util.logging.Logger.getLogger(InputDataPemesanan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new InputDataPemesanan().setVisible(true);
//            }
//        });
//    }
