 ...
 * @author PUTRI
 */
public class KasirDataPemesanan extends javax.swing.JFrame {

    /**
     * Creates new form Supplier
     */
    public KasirDataPemesanan() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tabPemesanan = new javax.swing.JTable();
        ...
        judulLbl.setText("Detail Pemesanan");
        ...
        tabPemesanan.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id_pemesanan", "Tgl_pemesanan", "Total_pemesanan"
            }
        ) {
        ...
        tabPemesanan.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        output.setViewportView(tabPemesanan);

        getContentPane().add(output, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 140, 620, 220));
    ...
    public void setKeyPressedListener(KeyListener k){
        tfCari.addKeyListener(k);
    }

//    @Override
//    public synchronized void addKeyListener(KeyListener l) {
//        tfSearch.addKeyListener(l);
//    }
...
//            java.util.logging.Logger.getLogger(KasirDataPemesanan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new KasirDataPemesanan().setVisible(true);
//            }
//        });
//    }
    ...
    private javax.swing.JTable tabPemesanan;
